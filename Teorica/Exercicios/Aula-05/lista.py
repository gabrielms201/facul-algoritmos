...
def thirdExercise(fileDir):
    ...
    for i in range(3):
        ...
        largada = input("Digite a ordem de largada: ").split(" ")
        chegada = input("Digite a ordem de chegada: ").split(" ")
        largada = Methods.selectionSort(largada)
        sum = 0
        for i in range(0, len(chegada)-1):
...
main(showFirst = False, showSecond = False, showThird = True)